...
urlpatterns = [
    ...
    path('add_member/<int:group_id>/<int:user_id>', add_member, name='add_member'),
    ...
    path('kick_user/<int:group_id>/<int:user_id>/', kick_user, name='kick_user'),
    path('search_members/<int:group_id>', search_members, name = 'search_members'),
